...
const config = {
  ...
  tagline:
    'Ready-to-deploy full stack AI inferencing server offering unprecedented performance and flexibility.',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://inversefirm.github.io',
  ...
  organizationName: 'inversefirm', // Usually your GitHub org/user name.
  projectName: 'inversefirm.github.io', // Usually your repo name.
